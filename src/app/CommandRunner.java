...
public final class CommandRunner {
    ...
    public static ObjectNode seeMerch(final CommandInput commandInput) {
        ...
        try {
            List<String> merchandise = admin.seeMerch(commandInput.getUsername());
            objectNode.put("result", objectMapper.valueToTree(merchandise));
    ...
    public static ObjectNode wrapped(final CommandInput commandInput) {
        ...
        try {
            StatisticsOutput statisticsOutput = user.wrapped();
            objectNode.put("result", objectMapper.valueToTree(statisticsOutput));
    ...
    public static ObjectNode getNotifications(final CommandInput commandInput) {
        List<Notification> notifications = admin.getNotifications(commandInput.getUsername());
    ...
    public static ObjectNode endProgram() {
        ...
        objectNode.put("result", objectMapper.valueToTree(monetizationOutput));
