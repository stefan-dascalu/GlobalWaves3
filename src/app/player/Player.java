...
public final class Player {
    ...
    public static PlayerSource createSource(final String type,
        ...
        if ("song".equals(type)) {
            return new PlayerSource(Enums.PlayerSourceType.LIBRARY,
                    (AudioFile) entry, statistics);
        } else if ("playlist".equals(type)) {
            return new PlayerSource(Enums.PlayerSourceType.PLAYLIST,
                    (AudioCollection) entry, statistics);
        } else if ("podcast".equals(type)) {
            return createPodcastSource((AudioCollection) entry, bookmarks, statistics);
    ...
    private static PlayerSource createPodcastSource(final AudioCollection collection,
        ...
        return new PlayerSource(Enums.PlayerSourceType.PODCAST, collection, statistics);
    }
    ...
    public void setSource(final LibraryEntry entry, final String sourceType,
        ...
        this.source = createSource(sourceType, entry, bookmarks, statistics);
        this.repeatMode = Enums.RepeatMode.NO_REPEAT;
        this.shuffle = false;
        this.paused = true;
    }
